...
class Server
{
	...
	public:
		...
		//mode -marcus-
		std::string	modeTo_execute(char opera, char mode, std::string modeCommand);
		std::string	invite_only(Channel *targetChannel, char operation, std::string modeCommand);
};
